//C3 StringBuffer
//C17 Задано текст та масив слів. Підрахувати у скількох реченнях зустрічається кожне слово масиву.
...
public class third {
    public static void main(String[] args) {
        ...
        if (text.isEmpty()) {
            ...
            // Виводимо результати
            for (String word : words) {
                System.out.println("Слово '" + word + "' зустрічається в "
                        + wordCounts.getOrDefault(word.toLowerCase(), 0) + " реченнях.");
            }
